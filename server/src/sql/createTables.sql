...
create table if not exists dbo.followers(
    user_id int not null,
...
create table if not exists dbo.fridge(
...
create table if not exists dbo.recipe(
    id serial primary key,
...
create table if not exists dbo.recipe_rating(
...
create table if not exists dbo.collection_recipe(
...
create table if not exists dbo.meal_planner(
    user_id int not null,
    date date not null,
...
create table if not exists dbo.meal_planner_recipe(
    user_id int not null,
    date date not null,
    recipe_id int not null,
...
create or replace trigger trg_delete_product_with_no_quantity
