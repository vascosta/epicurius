...
class RecipeController(private val recipeService: RecipeService) {
    ...
    fun searchRecipes(
        ...
        @RequestParam cuisine: Set<Cuisine>?,
        @RequestParam mealType: Set<MealType>?,
        @RequestParam ingredients: Set<String>?,
        @RequestParam intolerances: Set<Intolerance>?,
        @RequestParam diets: Set<Diet>?,
