...
class RecipeDomain {
    ...
    companion object {
        ...
        const val INSTRUCTIONS_STEP_LENGTH_MSG = "Instructions step length must be between $MIN_INSTRUCTIONS_STEP_LENGTH and $MAX_INSTRUCTIONS_STEP_LENGTH characters"
