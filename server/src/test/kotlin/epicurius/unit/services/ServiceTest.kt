...
open class ServiceTest : EpicuriusUnitTest() {
    ...
    companion object {
        ...
        fun updateProfilePicture(userId: Int, profilePictureName: String? = null, profilePicture: MultipartFile) =
        ...
        suspend fun getUserRecipes(userId: Int, username: String?, lastRecipeId: Int?, limit: Int) =
            recipeService.getUserRecipes(userId, username, lastRecipeId, limit)
