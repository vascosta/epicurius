...
open class UserRepositoryTest : RepositoryTest() {
    ...
    companion object {
        ...
        fun checkUserVisibility(authorUsername: String, authorId: Int, username: String) =
            tm.run { it.userRepository.checkUserVisibility(authorUsername, authorId, username) }
    }
}
