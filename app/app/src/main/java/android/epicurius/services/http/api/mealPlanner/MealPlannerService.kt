package android.epicurius.services.http.api.mealPlanner

import android.epicurius.domain.mealPlanner.MealTime
import android.epicurius.services.http.HttpService
import android.epicurius.services.http.api.mealPlanner.models.input.AddMealPlannerInputModel
import android.epicurius.services.http.api.mealPlanner.models.input.CreateMealPlannerInputModel
import android.epicurius.services.http.api.mealPlanner.models.input.UpdateDailyCaloriesInputModel
import android.epicurius.services.http.api.mealPlanner.models.input.UpdateMealPlannerInputModel
import android.epicurius.services.http.api.mealPlanner.models.output.DailyMealPlannerOutputModel
import android.epicurius.services.http.api.mealPlanner.models.output.GetWeeklyMealPlannerOutputModel
